...
cd LeetcodeProblem_Solutions/Problem

Replace 'Problem_Question' with the specific problem directory you want to access.

3.Open the 'Probelm_Question.cpp' file to view the implementation.

4.Read the accompanying 'README.md' file to view the problem.

5.Compile and run the solution using your preferred C++ compiler.
...
## License
This repository is licensed under the MIT License. Feel free to use the code in any way that is consistent with this license.


Save the content to a file with the extension `.md` (e.g., `README.md`) to create the Markdown file.
...
|  |
| ------- |
| [0197-rising-temperature](https://github.com/aayushsingh8217/LeetcodeProblem_Solutions/tree/master/0197-rising-temperature) |
| [0584-find-customer-referee](https://github.com/aayushsingh8217/LeetcodeProblem_Solutions/tree/master/0584-find-customer-referee) |
